...
export class ClassController {
    ...
    create(@Body() createClassDto: CreateClassDto, @CurrentUser("sub") userId: string) {
        return this.classService.create(createClassDto, userId);
    }

    @Get()
    findAll(@CurrentUser("sub") userId: string, @Query() filters?: FilterClassDto) {
        return this.classService.findAll(userId, filters);
    }

    @Get("team/:teamId")
    findByTeam(@Param("teamId") teamId: string, @CurrentUser("sub") userId: string) {
    ...
    update(@Param("id") id: string, @Body() updateClassDto: UpdateClassDto, @CurrentUser("sub") userId: string) {
